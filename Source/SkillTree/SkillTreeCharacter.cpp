...
void ASkillTreeCharacter::BeginPlay()
{
	Super::BeginPlay();
...
void ASkillTreeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASkillTreeCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ASkillTreeCharacter::Look);
	...
	{
		UE_LOG(LogSkillTree, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void ASkillTreeCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASkillTreeCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASkillTreeCharacter::DoMove(float Right, float Forward)
{
...
void ASkillTreeCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ASkillTreeCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ASkillTreeCharacter::DoJumpEnd()
{
